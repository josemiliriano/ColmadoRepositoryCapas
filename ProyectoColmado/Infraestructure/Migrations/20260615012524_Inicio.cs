    ...
    public partial class Inicio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovementTypes", x => x.IdMovementType);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdInventoryMovement = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryMovements", x => x.IdInventoryMovement);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryMovements_Providers_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_ProviderId",
                table: "InventoryMovements",
                column: "ProviderId");
